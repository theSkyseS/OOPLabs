...
namespace Lesson_6
{
    ...
    class Computer : IComputer, IOverlock
    {
        ...
        event EventDelegate userAdded = null;
        event EventDelegate processorChanged = null;
        event EventDelegate programInstalled = null;
        event EventDelegate ramChanged = null;

        public event EventDelegate UserAdded
        {
            add
            {
        ...
        public event EventDelegate ProcessorChanged
        {
            add
            {
                processorChanged += value;
            }
            remove
            {
                processorChanged -= value;
        ...
        public event EventDelegate ProgramInstalled
        {
            add
            {
                programInstalled += value;
            }
            remove
            {
                programInstalled -= value;
        ...
        public event EventDelegate RamChanged
        {
            add
            {
                ramChanged += value;
        ...
        {
            userAdded.Invoke();
            processorChanged.Invoke();
            programInstalled.Invoke();
            ramChanged.Invoke();
        }
